...
Source0  : https://downloads.unidata.ucar.edu/udunits/2.2.28/udunits-2.2.28.tar.gz
...
%prep
%setup -q -n udunits-2.2.28
cd %{_builddir}/udunits-2.2.28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676075609
...
cp %{_builddir}/udunits-%{version}/COPYRIGHT %{buildroot}/usr/share/package-licenses/udunits/1201ba41648bc95438bc2529ba3691dbc76438ef || :
%make_install
